...
int main()
{
	...
	int array[numberofFD][numberofAttributes], candidateKey[numberofAttributes][numberofAttributes], relations[numberofFD][numberofAttributes], r = 1, countKeys = 0, index = 0, temp = 0, count;
